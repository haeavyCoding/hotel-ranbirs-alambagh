...
<body>
    ...
    <div class="offcanvas-menu-wrapper w-75">
        ...
        <ul class="top-widget">
            <li><i class="fa fa-phone"></i> +05224327173</li>
            <li><i class="fa fa-envelope"></i>  reseravtaion@hotelranbirsalamabagh.com</li>
        </ul>
    </div>
