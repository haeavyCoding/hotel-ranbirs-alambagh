...
<!-- Breadcrumb -->
<div class="breadcrumb-wrapper" style="background: #f8f8f8; padding: 15px 0;">
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb" style="margin: 0; padding: 0; list-style: none; display: flex;">
                <li class="breadcrumb-item" style="margin-right: 10px;"><a href="/" style="color: #d4af37; text-decoration: none;">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page" style="color: #666;">Rooms & Suites</li>
            </ol>
        </nav>
    </div>
</div>
                    ...
                    <div class="room-details" style="padding: 40px;">
                        <div class="room-header" style="margin-bottom: 20px;">
                            ...
                            <div class="room-rating" style="color: #d4af37; font-size: 0.9rem;">
                                ...
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <span style="color: #777; margin-left: 8px;">5.0 (120 reviews)</span>
                            </div>
                        </div>
                        
                        <div class="room-specs" style="display: flex; gap: 25px; margin: 20px 0;">
                            <div class="spec-item" style="display: flex; align-items: center;">
                                <i class="fas fa-ruler-combined" style="margin-right: 8px; color: #d4af37;"></i>
                                <span style="color: #555;">120 sq.ft</span>
                            </div>
                            <div class="spec-item" style="display: flex; align-items: center;">
                                <i class="fas fa-bed" style="margin-right: 8px; color: #d4af37;"></i>
                                <span style="color: #555;">Double Bed</span>
                            </div>
                            <div class="spec-item" style="display: flex; align-items: center;">
                                <i class="fas fa-user-friends" style="margin-right: 8px; color: #d4af37;"></i>
                                <span style="color: #555;">Max: 2 Adults</span>
                            </div>
                        </div>
                        ...
                        <ul class="room-features" style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 30px; padding: 0; list-style: none;">
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-wifi" style="margin-right: 10px; color: #d4af37;"></i> Free High-Speed WiFi
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-tv" style="margin-right: 10px; color: #d4af37;"></i> 32" Smart LED TV
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-coffee" style="margin-right: 10px; color: #d4af37;"></i> Tea/Coffee Maker
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-snowflake" style="margin-right: 10px; color: #d4af37;"></i> Air Conditioning
                            </li>
                        </ul>
                    ...
                    <div class="room-details" style="padding: 40px;">
                        <div class="room-header" style="margin-bottom: 20px;">
                            ...
                            <div class="room-rating" style="color: #d4af37; font-size: 0.9rem;">
                                ...
                                <span style="color: #777; margin-left: 8px;">4.5 (86 reviews)</span>
                            </div>
                        </div>
                        ...
                        <div class="room-specs" style="display: flex; gap: 25px; margin: 20px 0;">
                            <div class="spec-item" style="display: flex; align-items: center;">
                                <i class="fas fa-ruler-combined" style="margin-right: 8px; color: #d4af37;"></i>
                                <span style="color: #555;">140 sq.ft</span>
                            </div>
                            <div class="spec-item" style="display: flex; align-items: center;">
                                <i class="fas fa-bed" style="margin-right: 8px; color: #d4af37;"></i>
                                <span style="color: #555;">Twin Beds</span>
                            </div>
                            <div class="spec-item" style="display: flex; align-items: center;">
                                <i class="fas fa-user-friends" style="margin-right: 8px; color: #d4af37;"></i>
                                <span style="color: #555;">Max: 3 Adults</span>
                            </div>
                        </div>
                        ...
                        <ul class="room-features" style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 30px; padding: 0; list-style: none;">
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-utensils" style="margin-right: 10px; color: #d4af37;"></i> Mini Refrigerator
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-laptop" style="margin-right: 10px; color: #d4af37;"></i> Work Desk
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-lock" style="margin-right: 10px; color: #d4af37;"></i> Electronic Safe
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-concierge-bell" style="margin-right: 10px; color: #d4af37;"></i> 24/7 Room Service
                            </li>
                        </ul>
                    ...
                    <div class="room-details" style="padding: 40px;">
                        <div class="room-header" style="margin-bottom: 20px;">
                            ...
                            <div class="room-rating" style="color: #d4af37; font-size: 0.9rem;">
                                ...
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <span style="color: #777; margin-left: 8px;">5.0 (64 reviews)</span>
                            </div>
                        </div>
                        ...
                        <div class="room-specs" style="display: flex; gap: 25px; margin: 20px 0;">
                            ...
                            <div class="spec-item" style="display: flex; align-items: center;">
                                <i class="fas fa-bed" style="margin-right: 8px; color: #d4af37;"></i>
                                <span style="color: #555;">King Size Bed</span>
                            </div>
                            <div class="spec-item" style="display: flex; align-items: center;">
                                <i class="fas fa-couch" style="margin-right: 8px; color: #d4af37;"></i>
                                <span style="color: #555;">Sitting Area</span>
                            </div>
                        </div>
                        ...
                        <ul class="room-features" style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 30px; padding: 0; list-style: none;">
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-umbrella-beach" style="margin-right: 10px; color: #d4af37;"></i> Complimentary Breakfast
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-shower" style="margin-right: 10px; color: #d4af37;"></i> Rainfall Shower
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-gem" style="margin-right: 10px; color: #d4af37;"></i> Premium Toiletries
                            </li>
                            <li style="display: flex; align-items: center; color: #555;">
                                <i class="fas fa-clock" style="margin-right: 10px; color: #d4af37;"></i> Late Check-Out*
                            </li>
                        </ul>
    ...
    <div class="container">
        ...
        <div class="amenities-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px;">
            <div class="amenity-item" style="background: #fff; padding: 30px; border-radius: 10px; text-align: center; box-shadow: 0 5px 20px rgba(0,0,0,0.05); transition: all 0.3s;">
                ...
                <h4 style="font-size: 1.2rem; margin-bottom: 15px; color: #222;">High-Speed WiFi</h4>
            ...
            <div class="amenity-item" style="background: #fff; padding: 30px; border-radius: 10px; text-align: center; box-shadow: 0 5px 20px rgba(0,0,0,0.05); transition: all 0.3s;">
                ...
                <h4 style="font-size: 1.2rem; margin-bottom: 15px; color: #222;">Secure Parking</h4>
    ...
    <div class="container">
        <div class="cta-content text-center" style="max-width: 800px; margin: 0 auto;">
            ...
            <ul style="list-style: none; padding: 0; display: flex; justify-content: center; gap: 30px; margin-bottom: 40px;">
                ...
                <li style="display: flex; align-items: center; font-size: 1.1rem;">
                    <i class="fas fa-check" style="color: #d4af37; margin-right: 10px;"></i> Free Room Upgrade*
                </li>
                <li style="display: flex; align-items: center; font-size: 1.1rem;">
